#!/bin/bash
#SBATCH --job-name=zero-1.5b-2gpu
#SBATCH --nodes=1
#SBATCH --mem=100G
...
export N_GPUS=2
export BASE_MODEL=/scratch/gpfs/sl2998/cache/hub/models--Qwen--Qwen2.5-1.5B/snapshots/8faed761d45a263340a0528343f099c05c9a4323
export MODEL_SIZE=1.5b
export DATA_DIR=/scratch/gpfs/sl2998/data/tinyzero
...
export EXPERIMENT_NAME=countdown-qwen2.5-$MODEL_SIZE-$RANDOM_SEED
